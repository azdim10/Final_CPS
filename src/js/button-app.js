const buttonShowCheck = document.querySelector('.upperMenu_button-app')
const buttonHideCheck = document.querySelector('.application_btn')
const windowAdept = window.matchMedia('(min-width:760px)')
const feedbackElement = document.querySelector('.application')
